...
def main(ticker_symbols, start_date, end_date, reweight_interval, output_folder):
    # Assuming MarkowitzPortfolio is a class that you have defined
    # portfolio = MarkowitzPortfolio(ticker_symbols, start_date, end_date)
    # portfolio.calculate_optimal_weights(reweight_interval)
...
if __name__ == '__main__':
    ...
    # Assuming main is a function that takes these arguments and runs the portfolio experiment
    main(args.tickers, args.start, args.end, args.reweight, args.output)
